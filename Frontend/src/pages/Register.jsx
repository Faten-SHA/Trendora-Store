      ...
      <div className="flex items-center bg-white shadow-lg rounded-lg overflow-hidden ">
        ...
        <div className="p-10 w-[500px] ">
          ...
          <div className="mb-5">
            ...
            <button className="w-full py-2 bg-[#E82561] text-white font-bold rounded-md transition-transform duration-500 hover:bg-[#F2AE66] focus:outline-none focus:ring-red-500 transform hover:scale-105 ">Create Account</button>
          <div className="mt-4 text-sm text-gray-600">
            <span>Have an account already?</span>
            <Link to="/login" className="text-[#E82561] font-bold hover:underline ml-1">
            Login
            </Link>
          </div>
